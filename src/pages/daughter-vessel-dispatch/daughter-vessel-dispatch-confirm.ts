...
@Component({
  selector: 'daughter-mother-vessel-dispatch-confirm',
  templateUrl: 'daughter-vessel-dispatch-confirm.html',
})
export class DaughterVesselDispatchConfirm {
  ...
  confirm() {
    ...
    this.data.status_id = 66; 
    this.global.showLoading();
    this.authHttp.post(this.global.public_url + 'daughter_vessel_dispatches', this.data)
